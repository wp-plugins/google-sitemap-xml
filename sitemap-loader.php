...
class GoogleSitemapGeneratorLoader {
	 ...
	 */
	private static $svnVersion = '$Id: sitemap-loader.php 937300 2015-01-23 $';
	...
	public static function RegisterPluginLinks($links, $file) {
		...
		if($file == $base) {
			...
			$links[] = '<a href="http://www.amplemoney.com/">' . __('FAQ', 'sitemap') . '</a>';
			$links[] = '<a href="http://www.amplemoney.com/">' . __('Support', 'sitemap') . '</a>';
			$links[] = '<a href="http://www.amplemoney.com/">' . __('Work', 'sitemap') . '</a>';
		}
		return $links;
	}
	...
	public static function CallHtmlShowHelpList() {
		...
		if(is_object($screen) &&  $screen->id == $id) {
			...
			$links = array(
				__('Plugin Homepage', 'sitemap') => 'http://www.amplemoney.com/',
				__('My Sitemaps FAQ', 'sitemap') => 'http://www.amplemoney.com/'
			);
	 ...
	 *
	 * @return string The version like 1.0
	 */
