...
/*
 ...
 $Id: sitemap-core.php 935247 2015-01-19 $
...
final class GoogleSitemapGenerator {
	...
	public static function GetRedirectLink($redir) {
		return trailingslashit("http://www.amplemoney.com/" . $redir);
	}
	...
	private function BuildSitemapHeader($format) {
		...
		$this->AddElement(new GoogleSitemapGeneratorDebugEntry("sitemap-generator-url=\"http://www.amplemoney.com\" sitemap-generator-version=\"" . $this->GetVersion() . "\""));
	...
	/**
	 * Shows the option page of the plugin. Before 1.0, this function was basically the UI, afterwards the UI was outsourced to another class
	 *
	 * @see GoogleSitemapGeneratorUI
	 * @since 1.0
	 * @return bool
